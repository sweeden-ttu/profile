...
# - For UCS/A*, we maintain best-known path costs to support optimality.
# """
# Author: Scott Douglas Weeden
# Date: 2025-10-03
import util
...
class DFS(object):
    ...
    frontier (`util.Stack`) and a `visited` set to avoid revisiting states.
    Returns a sequence of actions from start to a goal, or [] if none.
    """
