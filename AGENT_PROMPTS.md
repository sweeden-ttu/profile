# Agent Prompts for Blog Post Generation

This document contains the structured prompts that guide each agent through the blog post generation process.
...
1. **Initialize Agent:** Use Agent Initialization Prompt
2. **Process Each Lecture:** Follow phases 1-5 sequentially
3. **Track State:** Update state after each action
4. **Reflect:** Use reflection template at each checkpoint
5. **Iterate:** Repeat review/refinement until approved
6. **Finalize:** Complete final approval when ready

**Key Principles:**
- Always check success criteria before proceeding
- Document decisions and rationale
- Maintain state tracking throughout
- Use reflection to identify issues early
