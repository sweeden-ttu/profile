...
course_slug: analysis-of-algorithms
course_number: CS-5381
canvas_id: 37735
...
{% assign course_data = site.data.courses | where: "slug", "analysis-of-algorithms" | first %}
...
Design and analysis of algorithms including complexity analysis, divide and conquer, dynamic programming, greedy algorithms, graph algorithms, and NP-completeness.

## Topics

- Algorithm complexity analysis (Big-O, Big-Omega, Big-Theta)
...
- [Course Blog Posts](/blog/?course=Analysis%20of%20Algorithms)
- Canvas Course: Course ID 37735
...
{% assign course_drafts = site.drafts | where: "course", "Analysis of Algorithms" | sort: "date" | reverse | limit: 5 %}
...
{% assign course_projects = site.projects | where: "course", "Analysis of Algorithms" | sort: "date" | reverse | limit: 5 %}
...
{% assign course_posts = site.posts | where: "course", "Analysis of Algorithms" | sort: "date" | reverse | limit: 5 %}
{% if course_posts.size > 0 %}
  <div style="border: 1px solid #e2e8f0; border-radius: 8px; padding: 1.5rem; background: #ffffff;">
    ...
    <a href="/blog/?course=Analysis%20of%20Algorithms" style="color: #3b82f6; text-decoration: none; font-size: 0.875rem; margin-top: 1rem; display: inline-block;">View All Posts →</a>
  </div>
{% else %}
  <div style="border: 1px solid #e2e8f0; border-radius: 8px; padding: 1.5rem; background: #f8fafc; color: #64748b;">
